...
std::string Literal::debug_string() const {


    std::string ret = "(Literal)";
    ...
    switch (_type.type) {
        ...
        case TYPE_TINYINT:{
            ret +=  _value.tinyint_val ;
            break;
        }
        case TYPE_SMALLINT:{
            ret += _value.smallint_val ;
            break;
        }
        case TYPE_INT:{
            ret += _value.int_val ;
        ...
        case TYPE_BIGINT:{
            ret +=  _value.bigint_val ;
            break;
        }
        case TYPE_LARGEINT:{
            ret += _value.large_int_val ;
            break;
        }
        case TYPE_FLOAT:{
            ret += _value.float_val ;
            break;
        }
        case TYPE_DOUBLE:{
            ret += _value.double_val ;
            break;
        }

        case TYPE_DATE:
        case TYPE_DATETIME:{
            ret +=  _value.datetime_val;
            break;
        }
        case TYPE_CHAR:
        case TYPE_VARCHAR:{
            ret += _value.string_data;
            break;
        }

        case TYPE_DECIMAL:{
            ret +=  _value.decimal_val.to_string() ;
            break;
        }
        default:
            break;
